...
{
    class MultiSDITextApplication : WindowsFormsApplicationBase
    {

        #region Member Variables & Properties
        static MultiSDITextApplication application;
        #endregion
        /**
         ...
         */
        internal static MultiSDITextApplication Application
        {
            get
            {
                if (application == null)
                    application = new MultiSDITextApplication();
                return application;
            }
        }
         ...
         */
        public MultiSDITextApplication()
        {
